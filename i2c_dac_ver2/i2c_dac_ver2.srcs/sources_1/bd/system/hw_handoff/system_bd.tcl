...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_IIC_0] [get_bd_intf_ports IIC_0_0] [get_bd_intf_pins system_ila_0/SLOT_0_IIC]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_ports LEDS] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins ila_0/probe0] [get_bd_pins vio_0/probe_in0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
